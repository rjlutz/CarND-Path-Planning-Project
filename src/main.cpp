...
int main() {
  ...
  double ref_vel = 49.5;   // mph, move a reference velocity to target, FROM Walkthrough
  ...
  h.onMessage([&lane,&ref_vel,&cold,&map_waypoints_x,&map_waypoints_y,&map_waypoints_s,&map_waypoints_dx,&map_waypoints_dy](uWS::WebSocket<uWS::SERVER> ws, char *data, size_t length,
                     uWS::OpCode opCode) {
